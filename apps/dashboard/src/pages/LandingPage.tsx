...
import {
  ...
  Sparkles, Play, ExternalLink, Check, X
} from 'lucide-react';
...
const STEPS = [
  { num: '01', title: 'Label a Ticket', desc: 'Tag any task with ai-sdlc in Jira, GitHub Issues, GitLab, or Linear', icon: Terminal, color: 'from-blue-500 to-indigo-500' },
...
const PRICING = [
  {
    ...
    cta: 'Deploy Now',
    ctaLink: 'https://github.com/nmime/ai-sdlc-orchestrator',
    highlight: false,
  },
  {
    name: 'Cloud',
  ...
  },
  {
    ...
    excluded: [],
    cta: 'Contact Sales',
    ctaLink: 'mailto:sales@ai-sdlc.dev',
    highlight: false,
  },
];
      ...
      <header className={`border-b sticky top-0 z-50 transition-all duration-300 ${scrolled ? 'border-divider bg-background/90 backdrop-blur-xl shadow-sm' : 'border-transparent bg-transparent'}`}>
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm text-default-600">
            ...
            <a href="https://github.com/nmime/ai-sdlc-orchestrator" target="_blank" rel="noreferrer" className="hover:text-foreground transition-colors flex items-center gap-1">Docs <ExternalLink size={12} /></a>
          </nav>
          <div className="flex items-center gap-3">
      ...
      <section className="relative pt-24 pb-32 px-6 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative">
          ...
          <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4 animate-slide-up">
            ...
            <a href="https://github.com/nmime/ai-sdlc-orchestrator" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 px-8 py-4 rounded-xl border border-divider text-foreground font-semibold text-lg hover:bg-default-100 transition-all hover:-translate-y-0.5">
...
[agent]        Creating branch: ai-sdlc/fix-auth-142
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="font-bold text-foreground">AI SDLC</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="https://github.com/nmime/ai-sdlc-orchestrator" target="_blank" rel="noreferrer" className="text-sm text-default-500 hover:text-foreground transition-colors">Documentation</a></li>
                <li><a href="https://github.com/nmime/ai-sdlc-orchestrator" target="_blank" rel="noreferrer" className="text-sm text-default-500 hover:text-foreground transition-colors">GitHub</a></li>
                <li><a href="https://github.com/nmime/ai-sdlc-orchestrator/blob/main/CHANGELOG.md" target="_blank" rel="noreferrer" className="text-sm text-default-500 hover:text-foreground transition-colors">Changelog</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="https://github.com/nmime/ai-sdlc-orchestrator/blob/main/LICENSE" target="_blank" rel="noreferrer" className="text-sm text-default-500 hover:text-foreground transition-colors">MIT License</a></li>
              </ul>
            </div>
          </div>
          <div className="mt-8 pt-8 border-t border-divider flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-sm text-default-400">© {new Date().getFullYear()} AI SDLC. Open source under MIT license.</p>
            <div className="flex items-center gap-4">
              <a href="https://github.com/nmime/ai-sdlc-orchestrator" target="_blank" rel="noreferrer" className="text-default-400 hover:text-foreground transition-colors">
                <GitHubIcon size={18} />
              </a>
            </div>
          </div>
