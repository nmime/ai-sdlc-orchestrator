...
export const DEMO_WORKFLOWS = [
  ...
  { id: 'wf-006', taskTitle: 'Implement WebSocket real-time notifications', status: 'completed', repoUrl: 'https://github.com/opwerf/platform', branchName: 'opwerf/ws-notifications', totalCostUsd: 4.21, aiCostUsd: 3.56, sandboxCostUsd: 0.65, startedAt: d(2), completedAt: d(2), agentProvider: 'anthropic', agentModel: 'claude-sonnet-4-20250514', temporalWorkflowId: 'wf-run-006', pullRequestUrl: 'https://github.com/opwerf/platform/pull/138' },
